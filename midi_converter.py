...
GENERATION_DIR = '/Users/sagnew/Talks/PyGotham/tmp/polyphony_rnn/generated'
soundfont = '/Users/sagnew/Talks/PyGotham/Famicom.sf2'
rnn_model = '~/Talks/PyGotham/polyphony_rnn.mag'
...
def generate_midi(call_sid):
    ...
    args = ['polyphony_rnn_generate',
            '--run_dir', 'tmp/polyphony_rnn/logdir/run2/train/model',
